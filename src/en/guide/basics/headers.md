...
Most of the time you will want to use the .get() or .getone() method can be used to access the first element and not a list. If you do want a list of all items, you can use .getall(). 
