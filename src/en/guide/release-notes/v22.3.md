...
The `Authorization` header has been partially parseable for some time now. You have been able to use `reques.token` to gain access to a header that was in one of the following two forms:
