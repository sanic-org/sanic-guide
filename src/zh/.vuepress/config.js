        ...
        items: [{
          ...
          },
          {
            ...
            items: [{
              ...
              {
                text: "中文文档",
                link: "/guide/zh/getting-started.md"
              }
            ],
          },
        ],
    ...
    sidebar: {
      "/guide/zh/": [{
        ...
        },
        {
          ...
          sidebarDepth: 1,
          children: [
            "/guide/zh/basics/app.md",
            "/guide/zh/basics/handlers.md",
            "/guide/zh/basics/request.md",
            "/guide/zh/basics/response.md",
            "/guide/zh/basics/routing.md",
            "/guide/zh/basics/listeners.md",
            "/guide/zh/basics/middleware.md",
            "/guide/zh/basics/headers.md",
            "/guide/zh/basics/cookies.md",
            "/guide/zh/basics/tasks.md",
          ],
        },
        {
          title: "进阶",
          sidebarDepth: 1,
          children: [
            "/guide/zh/advanced/class-based-views.md",
            "/guide/zh/advanced/proxy-headers.md",
            "/guide/zh/advanced/streaming.md",
            "/guide/zh/advanced/websockets.md",
            "/guide/zh/advanced/versioning.md",
          ],
        },
        {
          title: "最佳实践",
          sidebarDepth: 1,
          children: [
            "/guide/zh/best-practices/blueprints.md",
            "/guide/zh/best-practices/exceptions.md",
            "/guide/zh/best-practices/decorators.md",
            "/guide/zh/best-practices/logging.md",
            "/guide/zh/best-practices/testing.md",
          ],
        },
        {
          title: "运行和部署",
