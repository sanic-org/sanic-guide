...
?> **Heads up** Only post, put and patch decorators have stream argument.
...
?> **FYI** If a client supports HTTP/1.1, Sanic will use [chunked transfer encoding](https://en.wikipedia.org/wiki/Chunked_transfer_encoding); you can explicitly enable or disable it using chunked option of the stream function.
